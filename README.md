...
## 👥 AWS Cognito User Groups anlegen (feature-add-aws-cognito)

Falls du Cognito verwendest, kannst du User Groups wie folgt anlegen:
...
node ../../backend/scripts/createGroups.js <user-pool-id>
```

Dies erstellt die folgenden Gruppen:
- `admin`
- `instructor`
- `participant`
